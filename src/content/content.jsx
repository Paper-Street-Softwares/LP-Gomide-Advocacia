...
import icon from "../assets/imgs/icons/casa.webp";
import icon2 from "../assets/imgs/icons/Documento.webp";
import icon3 from "../assets/imgs/icons/Doctor.webp";
import icon4 from "../assets/imgs/icons/Escudo.webp";
...
const content = {
  texts: {
    ...
    ctaSecondary: {
      ...
      // miniTag: "FALE CONOSCO",
      title: (
        <h1 className="text-colorFooter">
          <span className="text-colorFooter">Dúvidas?</span> Entre em contato
          conosco para podermos lhe ajudar,{" "}
          <span className="text-colorFooter">estamos te esperando.</span>
        </h1>
      ),
      subtitleDireita: (
