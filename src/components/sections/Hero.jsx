      ...
      <div className="flex flex-col w-full desktop1:w-[50%] desktop1:mr-[20px]">
        <MotionDivDownToUp>
          <div className="flex justify-center w-auto text-center desktop1:justify-start desktop1:text-left font-secondFont text-paragraph4">
            <p
              className={`mb-[16px] rounded-md px-[16px] py-[6px] font-mainFont inline-block text-paragraph2 capitalize ${minititleColor}`}
            >
              {t("hero.miniTag")}
            </p>
          </div>
                  ...
                  <MotionDivDownToUp className="relative flex justify-center w-full">
                    <picture>
                      ...
                      <img
                        ...
                        ${
                          colorMode === "light"
                            ? "desktop1:shadow-custom-opacity desktop1:shadow-shadowHero/50"
                            : "shadow-custom-opacity shadow-shadowHero/50"
                        }`}
                      />
                    </picture>
                  </MotionDivDownToUp>
